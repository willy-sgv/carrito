...
if (move_uploaded_file($nombreTempImagen, $rutaImagen)) {
   ...
   $consulta = "INSERT INTO usuario (dni, apellidos_nombres, correo, telefono, direccion, fecha_nacimiento, password, activo, reset_password, token_password, id_rol, fotos) 
   VALUES ('$dni', '$apellidos_nombres', '$correo', '$telefono', '$direccion', '$fecha_nacimiento', '$password_encriptada', 1, 0, ' ', $id_rol, '$nombreImagen')";
